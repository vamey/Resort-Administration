...
def Booking():
    ...
    # type and it's price
    if ch == 0:
        print(" 1. Standard Non-AC - Rs. 5000 per day")
        print(" 2. Standard AC - Rs. 6000 per day")
        print(" 3. 3-Bed Non-AC - Rs. 7000 per day")
        print(" 4. 3-Bed AC - Rs. 9000 per day")
        ch = int(input("->"))
    if ch == 1:
